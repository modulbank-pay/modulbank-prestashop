...
class FPaymentsForm
{
    ...
    public function get_rebill_url()
    {
    ...
    public function send_request($method, $url, $data)
    {
        $response = false;
        $args     = array(
            'method'  => $method,
...
class FPaymentsRecieptItem
{
    ...
    public function __construct($title, $amount, $n = 1, $nds = null, $sno = null, $payment_object = null, $payment_method = null)
    {
